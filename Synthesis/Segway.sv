module Segway(clk,RST_n,INERT_SS_n,INERT_MOSI,INERT_SCLK,
			  ...
			  OVR_I_lft,OVR_I_rght,OVR_I_shtdwn,piezo_n,piezo,RX);
  ...
  output OVR_I_shtdwn;			// Added Missing signal from mtr_drv : TODO - Confirm it??
  ...
  localparam fast_sim = 0; // For FPGA and Synthesis
  // localparam fast_sim = 1; //Modified this for simulation
